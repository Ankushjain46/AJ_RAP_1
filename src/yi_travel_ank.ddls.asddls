...
@EndUserText.label: 'Interface view of YTRAVEL_MA'
...
define root view entity YI_TRAVEL_ANK
  as select from ytravel_ma
  composition [0..*] of YI_BOOKING_ANK           as _Booking
